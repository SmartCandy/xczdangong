...
?> 
      ...
      > <span class="f_l"><img src="themes/ecmoban_xiwang/images/btn_fold.gif" style="padding-top:10px;padding-right:6px;cursor:pointer;"></span> <a href="<?php echo $this->_var['cat']['url']; ?>" class="  f_l"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a>
      </h1>
      <ul style="" >
...
{ 	
	...
	if(obj_ul[id].style.display == "none")
	{
		...
		obj_img[id].src = "themes/ecmoban_xiwang/images/btn_unfold.gif";
//		if(id==1){
//			obj_ul[id].style.display = "none";
//			obj_img[id].src = "themes/ecmoban_xiwang/images/btn_fold.gif";
//		}
		return false;
	}
